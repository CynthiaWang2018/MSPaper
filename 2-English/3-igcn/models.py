...
class GCN_APPRO(Model):
    ...
    def _loss(self):
        ...
        # Cross entropy error # 这里不是掩码的交叉熵损失了
...
class GCN_APPRO_SGC(Model):
    def __init__(self, placeholders, input_dim, **kwargs):
        super(GCN_APPRO_SGC, self).__init__(**kwargs)
        self.inputs = placeholders['features']
        self.input_dim = input_dim
        # self.input_dim = self.inputs.get_shape().as_list()[1]  # To be supported in future Tensorflow versions
        self.output_dim = placeholders['labels'].get_shape().as_list()[1]
...
class APPNP(Model): #mixture of dense and appnp
    def __init__(self, placeholders, input_dim, **kwargs):
    ...
    def _build(self):
        ...
        self.layers.append(GraphPageRank(input_dim=FLAGS.hidden1,
                                            output_dim=self.output_dim,
                                            alpha=FLAGS.alpha,
                                            propagations=FLAGS.propagations,
                                            placeholders=self.placeholders,
                                            support=self.support,
                                            act=lambda x: x,
                                            dropout=True,
