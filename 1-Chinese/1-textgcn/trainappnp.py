...
datasets = ['20ng', 'R8', 'R52', 'ohsumed', 'mr', 'ag_news', 'dblp', 'TREC', 'WebKB','WebKB2','law','law2','medical2'] # Modify
dataset = sys.argv[1]
...
# 第一层的输出维度
flags.DEFINE_integer('hidden1', 200, 'Number of units in hidden layer 1 output dim.') # not used

flags.DEFINE_integer('hidden1_dim', 256, 'Number of units in hidden layer 1.')
flags.DEFINE_integer('hidden2_dim', 256, 'Number of units in hidden layer 2.') # not used
print('hidden1_dim',FLAGS.hidden1_dim)
flags.DEFINE_float('alpha', 0.01, 'alpha of APPNP.') # modify
